...
(function($){
    ...
    $.calendario = function(options){
        ...
        if($('#plugins_calendario_mascara').size() > 0) $('#plugins_calendario_mascara').remove();

		$('body').append('<div id="plugins_calendario_mascara"><div id="plugins_calendario"><div id="plugins_calendario_header"><div class="plugins_calendario_botoes" id="plugins_calendario_mes_anterior" data-acao="mes_anterior"></div><div class="plugins_calendario_texto" id="plugins_calendario_mes_texto">JUNHO</div><div class="plugins_calendario_botoes" id="plugins_calendario_mes_proximo" data-acao="mes_proximo"></div><div class="plugins_calendario_botoes" id="plugins_calendario_ano_anterior" data-acao="ano_anterior"></div><div class="plugins_calendario_texto" id="plugins_calendario_ano_texto">2016</div><div class="plugins_calendario_botoes" id="plugins_calendario_ano_proximo" data-acao="ano_proximo"></div><div class="plugins_calendario_botoes" id="plugins_calendario_fechar"></div></div><ul class="plugins_calendario_coluna" id="plugins_calendario_semana"><li>'+getSemana(0,3)+'</li><li>'+getSemana(1,3)+'</li><li>'+getSemana(2,3)+'</li><li>'+getSemana(3,3)+'</li><li>'+getSemana(4,3)+'</li><li>'+getSemana(5,3)+'</li><li>'+getSemana(6,3)+'</li></ul><ul class="plugins_calendario_coluna" id="plugins_calendario_datas"></ul><div id="plugin_calendario_rodape"><input type="text" id="plugins_calendario_hora" onClick="this.select()" data-mascara="hora" value="" placeholder="00:00:00"><div id="plugins_calendario_ok">OK</div><div class="plugins_calendario_agora" id="plugins_calendario_hoje">HOJE</div><div class="plugins_calendario_agora" id="plugins_calendario_agora">AGORA</div></div></div></div>');
		...
		$('body').on('click', settings.id, function(){
            $('#plugins_calendario_mascara').show().stop()
            .animate({opacity:0}, 0)
        ...
        var calendario_fechar = function(){
            $('#plugins_calendario_mascara').stop()
