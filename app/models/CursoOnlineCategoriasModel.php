<?php
    class CursoOnlineCategoriasModel extends Model {

        public $_tabela = 'curso_online_categorias';
            ...
            if($dados):
                foreach($dados as $r):
                    $array[] = (object)[
                        ...
                        'imagem' => (object)[
                            'valor' => $r->imagem,
                            'link' => (isset($r->imagem) && !empty($r->imagem)) ? ARQUIVO.'/online_categorias/'.$r->imagem : ''
                        ],
                        'url' => (object)[
                            'link' => LINK.'/categorias/'.$r->url,
                            'valor' => $r->url
                        ],
                        'data' => (object)array(
