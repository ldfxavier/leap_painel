	...
	<form action="<?=PAINEL?>/post-login">
		<fieldset>
			...
			<div class="legend border_cor">
				<figure>
					<!-- <img src="../images/painel/logo.png" alt=""> -->
				</figure>
				<span class="titulo_sub">SEJA BEM VINDO AO PAINEL ADMINISTRATIVO</span>
				<span class="titulo cor">FAÇA SEU LOGIN</span>
				<span class="texto">Acesse digitando seu e-mail e senha nos campos abaixo</span>
			</div>
			<div class="input">
				<label class="login">
...
body {
	background: linear-gradient(#262526,#4A494A);
