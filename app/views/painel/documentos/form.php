...
<div class="linha">
	<fieldset>
		...
		<label>Texto:</label>
		<input type="text" data-tamanho="" name="texto" value="<?= P::r($r, 'texto'); ?>" placeholder="Digite um texto">
...
<div class="linha">
	<fieldset>
		<?= Form::arquivo('ENVIAR DOCUMENTO', 'arquivo', P::r($r, 'arquivo->valor'), 'documentos', 'pdf/DOCX'); ?>
	</fieldset>
</div>
