...
<div class="center">
	<fieldset>
		...
		<?= Form::imagem('ENVIAR IMAGEM PRINCIPAL <span>(Será redirecionada para 650px)</span>', 'imagem', P::r($r, 'imagem->valor'), 'online_categorias', 'jpg/jpeg/png', 650, '30000', 'redimencionar', 'img');?>
	</fieldset>
	<fieldset>
