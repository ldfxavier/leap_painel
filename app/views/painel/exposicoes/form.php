...
<div class="center">
	...
	<fieldset>
		...
		<div class="cabecalho_data">
			<label>Data do início da exposição:</label>
			<?= Form::data('data_evento_inicio', P::r($r, 'data->evento_inicio->br'), null, true);?>
		</div>

		<div class="cabecalho_data">
			<label>Data do final da exposição</label>
	...
	<fieldset>
		...
		<?= Form::imagem('ENVIAR IMAGEM PRINCIPAL <span>(Será redirecionada para 650px)</span>', 'imagem', P::r($r, 'imagem->valor'), 'exposicoes', 'jpg/jpeg/png', 650, '30000', 'redimencionar', 'img');?>
	</fieldset>

	<fieldset>
		<div class="legenda">IMAGEM PARA REDE SOCIAL</div>
		<div class="imagem_social">
			<?= Form::imagem('IMAGEM REDE SOCIAL<span>(476x249 pixels)</span>', 'imagem_social', P::r($r, 'imagem_social->valor'), 'exposicoes', 'jpg/jpeg/png', 476, 249, 'cortar', 'img');?>
			<div class="dados">
